                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
                    ...
                    <motion.div className="space-y-4 max-w-80" variants={fadeUp}>
                        ...
                        <div className="flex items-center gap-3">
                            <SocialIcon icon={<FaXTwitter />} href="https://x.com/driftoapp" />
                    ...
                    <motion.div variants={fadeUp}>
                        ...
                        <ul className="space-y-3 text-sm text-gray-700">
                            <li><a href="#pricing" className="hover:text-blue-600 transition-colors">Services</a></li>
                    ...
                    <motion.div variants={fadeUp}>
                        ...
                        <ul className="space-y-3 text-sm text-gray-700">
                            ...
                            <li><a href="mailto:contact@drifto.app" className="hover:text-blue-600 transition-colors">Contact Us</a></li>
                        </ul>
                    </motion.div>
...
const SocialIcon = ({ icon, href }: { icon: React.ReactNode; href: string }) => {
    return (
        <a
            ...
            className="w-9 h-9 rounded-full border border-gray-300 flex items-center justify-center text-gray-700 hover:bg-gray-100 hover:text-blue-600 transition focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
        >
            {icon}
        </a>
    );
